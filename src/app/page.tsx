  ...
  <div className="flex flex-col items-center justify-center h-full">
    ...
    <div className="bg-white w-full rounded-2xl">
      <div className="flex justify-between items-center p-5">
        <div>
          <h1 className="text-xl"><Link href="">Brood War is a bad place</Link></h1>
      ...
      <div className="flex justify-between items-center p-5">
        <div>
          <h1 className="text-xl"><Link href="">All things StarCraft</Link></h1>
          <p>A place to chat about StarCraft and find games</p>
        </div>
        <div className="flex space-x-10 mr-5">
          <div>
    ...
    <div className="bg-white w-full rounded-2xl">
      <div className="flex justify-between items-center p-5">
        <div>
          <h1 className="text-xl">Kittens</h1>
          <p>A place to chat about StarCraft and find games</p>
        </div>
        <div className="flex space-x-10 mr-5">
          <div>
      ...
      <div className="flex justify-between items-center p-5">
        <div>
          <h1 className="text-xl">Kitten but theyre sleeping</h1>
          <p>A place to chat about StarCraft and find games</p>
        </div>
        <div className="flex space-x-10 mr-5">
          <div>
