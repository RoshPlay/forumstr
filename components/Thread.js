...
<div
  ...
  <h1 class="text-2xl text-left" >{description}</h1> <a  class=" no-underline text-white block w-full bg-white-200 hover:bg-black-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-full text-xl px-20 py-2.5 text-center dark:focus:ring-blue-900 select-none">View Forum</a>
              ...
              <th scope="col" class="px-6 py-4"> <a href={`/forum/${forumId}/thread/${threadId}/`} class="no-underline text-white block w-full bg-black hover:bg-black-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-full text-xl px-20 py-2.5 text-center dark:focus:ring-blue-900">View Threads</a>
                </th>
            </tr>
          </thead>
          <tbody> 
